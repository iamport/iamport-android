...
object Versions {
    const val versionCode = 210927003 // yymmdd000
    const val versionName = "1.1.0-hotfix03"  // https://www.notion.so/chaifinance/QA-Process-d1a4be396337493b81c6e85fff2d5cd6
